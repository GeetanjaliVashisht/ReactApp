    ...
    <Page title="Welcome" wide={true}>
      <div className="row align-items-center">
        <div className="col-lg-7 py-3 py-md-5">
          ...
          <p className="lead text-muted">Later on, turn it into a Blog post site. Also, since ur eyes are already here, complete your LFWOR book and carry on with polity. Good Luck.</p>
        </div>
